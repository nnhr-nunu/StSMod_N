...
class P {
  ...
  static void Main() {
    ...
    Dump(btn.GetMethod("_Input", BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Instance|BindingFlags.DeclaredOnly)!);
    Dump(btn.GetMethod("_GuiInput", BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Instance|BindingFlags.DeclaredOnly)!);
  }
}
