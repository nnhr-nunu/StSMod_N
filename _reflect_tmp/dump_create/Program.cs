...
class P {
  ...
  static void Main() {
    ...
    Dump(inv.GetMethod("Create", BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Static|BindingFlags.Instance));
    var rm = a.GetType("MegaCrit.Sts2.Core.Models.RelicModel")!;
    Dump(rm.GetMethod("get_Status", BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Instance|BindingFlags.DeclaredOnly));
    Dump(rm.GetMethod("get_HoverTips", BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Instance|BindingFlags.DeclaredOnly));
    Dump(rm.GetMethod("get_HoverTip", BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Instance|BindingFlags.DeclaredOnly));
  }
}
