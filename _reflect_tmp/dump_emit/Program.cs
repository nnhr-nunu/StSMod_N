...
class P {
  ...
  static void Main() {
    ...
    Dump(nc.GetMethod("EmitSignalMousePressed", BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Instance|BindingFlags.DeclaredOnly)!);
    Dump(nc.GetMethod("add_MousePressed", BindingFlags.Public|BindingFlags.NonPublic|BindingFlags.Instance|BindingFlags.DeclaredOnly)!);
  }
}
