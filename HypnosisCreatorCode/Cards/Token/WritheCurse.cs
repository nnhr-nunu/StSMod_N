...
/// <summary>苦悩 — 天賦。1ドロー。廃棄。SM。</summary>
[Pool(typeof(HypnosisCreatorCardPool))]
public class WritheCurse() : PlayableCurseCard(0,
    CardType.Curse, CardRarity.Curse, TargetType.AnyEnemy)
{
    public override string PortraitPath => "writhe.png".CardImagePath();
    public override string CustomPortraitPath => "writhe.png".BigCardImagePath();
