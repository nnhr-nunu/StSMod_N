...
/// <summary>はたき攻撃用 <c>audio/Hit-Slap</c> を Godot で再生する。</summary>
public static class SlapSfx
{
    private const string BaseName = "Hit-Slap";
    ...
    private static AudioStream? EnsureStream()
    {
        ...
        MainFile.Logger.Warn(
            $"Slap sfx not found under {MainFile.ResPath}/audio/{BaseName} (ogg/wav/mp3)");
        return null;
    }
}
