...
namespace NewCharMod.NewCharModCode.Cards;
...
/// </summary>
[Pool(typeof(NewCharModCardPool))]
public abstract class NewCharModCard(int cost, CardType type, CardRarity rarity, TargetType target) :
