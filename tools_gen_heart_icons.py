...
STEM_SKIN_PREFIX: dict[str, str] = {
    ...
    "BOWL_BUG_ROCK": "rock/",
    "BOWL_BUG_SILK": "web/",
    "TRACKER_RAIDER": "tracker/",
}

# Heart MonsterIdEntry → preferred atlas stem when auto-match fails
STEM_ALIASES: dict[str, str] = {
    "ASSASSIN_RAIDER": "assassin_ruby_raider",
    "AXE_RAIDER": "axe_ruby_raider",
    "BRUTE_RAIDER": "brute_ruby_raider",
    "CROSSBOW_RAIDER": "crossbow_ruby_raider",
    "TRACKER_RAIDER": "tracker_ruby_raider",
    "LEAF_SLIME_SMALL": "leaf_slime_s",
    "LEAF_SLIME_MED": "leaf_slime_m",
    "TWIG_SLIME_SMALL": "twig_slime_s",
    "TWIG_SLIME_MED": "twig_slime_m",
    "WET_CULTIST": "cultists",
    "ROCK_CULTIST": "cultists",
    "BYRDNIS": "byrdonis",
    "FOG_MOG": "fogmog",
    "GHOST_SHIP": "haunted_ship",
    "SOUL_FISH": "soul_fysh",
    "ENTMANCER": "entomancer",
    "CENTIPEDE": "decimillipede",
    "BOWL_BUG_EGG": "bowlbug",
    "BOWL_BUG_HONEY": "bowlbug",
    "BOWL_BUG_ROCK": "bowlbug",
    "BOWL_BUG_SILK": "bowlbug",
    "EXOSKELETON_BUG": "exoskeleton",
    "PHANTASMAL_BUG": "phantasmal_gardener",
    "PROGENITOR_BUG": "louse_progenitor",
    "PARASITIZED_PRISM": "infested_prism",
    "CUBEX": "cubex_construct",
    "RITUAL_BEAST": "ceremonial_beast",
    "BLOOD_PRIEST": "kin_priest",
    "THIEF_GRASSHOPPER": "thieving_hopper",
    "SHRINKER_BEETLE": "shrinker_beetle",
    "SLEEPING_BEETLE": "slumbering_beetle",
    "SLUDGE_SPINNER": "sludge_spinner",
    "BRISTLE_WORM": "fuzzy_wurm_crawler",
    "WRIGGLER": "wriggler",
    "VINE_SHAMBLER": "vine_shambler",
    "LIVING_FOG": "living_smog",
    "TWIN_TAIL_RAT": "two_tailed_rat",
    "SEWER_SHELL": "sewer_clam",
    "OVICOPTER": "ovicopter",
    "FLYCONID": "flying_mushrooms",
    "MAULER": "mawler",
    "PUNCH_MACHINE": "punch_construct",
    "TUNNELOR": "tunneler",
    "CONSTRICTOR": "slithering_strangler",
    "SPIKE_TOAD": "spiny_toad",
    "TOAD_KING": "toadpole",
    "TERROR_EEL": "terror_eel",
    "SEAPUNK": "seapunk",
    "OBSCURA": "the_obscura",
    "PHANTOM": "vantom",
    "MAW_BEAST": "the_insatiable",
    "SWARMING_HIVE": "skulking_colony",
    "ANCIENT_IDOL": "bygone_effigy",
    "JACKFRUIT": "snapping_jaxfruit",
...
def score_region(name: str, w: int, h: int, skin_prefix: str | None) -> int:
    ...
    if skin_prefix:
        if not low.startswith(skin_prefix.lower()):
            ...
            score += 50_000
    # Prefer recognizable portrait pieces
